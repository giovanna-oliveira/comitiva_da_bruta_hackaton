...
class Banco extends TRecord
{
    ...
    public function get_cliente_solicitacao_banco_to_string()
    {
        ...
        $values = ClienteSolicitacao::where('banco_id', '=', $this->id)->getIndexedArray('banco_id','{banco->nome}');
    ...
    public function get_cliente_solicitacao_cliente_to_string()
    {
        ...
        $values = ClienteSolicitacao::where('banco_id', '=', $this->id)->getIndexedArray('cliente_id','{cliente->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_cliente_to_string()
    {
        ...
        $values = Conta::where('banco_id', '=', $this->id)->getIndexedArray('cliente_id','{cliente->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_conta_banco_to_string()
    {
        ...
        $values = Conta::where('banco_id', '=', $this->id)->getIndexedArray('banco_id','{banco->nome}');
        return implode(', ', $values);
    }
